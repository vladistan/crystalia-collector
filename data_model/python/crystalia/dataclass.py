...
# Generation date: 2024-10-25T19:43:22
...
class DescribableThing(Thing):
    ...
    id: str | DescribableThingId = None
...
class Descriptor(DescribableThing):
    ...
    hasType: str | DescriptorTypeId = None
    value: str = None
    offset: int = None
    coverage: float = None
